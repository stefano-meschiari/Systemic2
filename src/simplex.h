...
/**
 * Attempts to converge to a local minimum of the kernel k, using the GSL simplex
 * algorithm. Many of the algorithm settings are determined by the kernel object:
